...
function Adduser()
{
  ...
  {
    header('Location: http://localhost/website/inscription/candidat.php?reg_err=already'); 
  }
  else if(is_numeric($telephone) && strlen($telephone) == 10)
  {
    echo $query="INSERT INTO users(nom, prenom, mail, mdp, telephone, classe) VALUES('".$nom."', '".$prenom."', '".$mail."', '".$mdp."', '".$telephone."', '".$classe."')";
  ...
  {
    header('Location: http://localhost/website/inscription/candidat.php?reg_err=tel'); 
  }
